...
const FALLBACK_TEASER_COVERS = [
  { image: "assets/portfolio2/identidade/jasu/0.webp", title: "Jasu — moda plus size", cat: "Identidade visual", href: "portfolio.html?cat=identidade#jasu" },
  { image: "assets/portfolio2/identidade/bemvita/0.webp", title: "BemVita — psicologia infantil", cat: "Identidade visual", href: "portfolio.html?cat=identidade#bemvita" },
  { image: "assets/portfolio2/identidade/brasa/0.webp", title: "Brasa — Delivery", cat: "Identidade visual", href: "portfolio.html?cat=identidade#brasa" },
  { image: "assets/portfolio2/sites/0.webp", title: "Sites & landing pages", cat: "Sites & landing pages", href: "portfolio.html?cat=sites" },
  { image: "assets/portfolio2/social/35.webp", title: "Sistemas visuais", cat: "Sistemas visuais", href: "portfolio.html?cat=social" },
  { image: "assets/portfolio2/outros/1.webp", title: "Outros materiais", cat: "Outros", href: "portfolio.html?cat=outros" }
];
