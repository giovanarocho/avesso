...
const RESEND_FROM = process.env.RESEND_FROM || 'rocho lab <contato@rocholab.com>';
// endereço de verdade da giovana — resend não deixa mandar "de" um
// gmail.com (só domínio verificado), então quem responde um e-mail
// automático cai aqui em vez de morrer na caixa do domínio.
const RESEND_REPLY_TO = process.env.RESEND_REPLY_TO || 'rocholab.estudio@gmail.com';
...
export async function resolvePrices() {
  ...
  return {
    ...
    // acompanhamento (mentoria guiada de 1 mês) — fica fora do ar por
    // enquanto, mas o preço continua resolvendo aqui pra não quebrar nada
    // que ainda leia esse campo.
    ...
    // suporte via whatsapp é gratuito pra quem comprou qualquer ferramenta
    // — não tem mais preço nenhum aqui.
    precos: precos,
