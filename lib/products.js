...
export const DEFAULT_PRODUCTS = [
  ...
  {
    slug: 'diagnostico',
    nome: 'diagnóstico de posicionamento',
    tagline: 'clareza sobre quem você é e o que te diferencia',
    mpDescription: 'Diagnóstico de Posicionamento - estúdio avesso',
    precoEnv: 'DIAGNOSTICO_PRICE',
    precoPadrao: 19.90,
    // a mesma página (/diagnostico) é a venda e a ferramenta — o "app" é
    // ela mesma, só que já desbloqueada depois do pagamento.
    appPath: '/diagnostico/index.html',
    vendaPath: '/diagnostico'
  }
];
